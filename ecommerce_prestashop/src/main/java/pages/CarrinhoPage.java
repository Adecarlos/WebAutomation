...
public class CarrinhoPage {
	...
	private By numerosItensTotal = By.cssSelector("span.js-subtotal");
	...
	private By summaryTotal = By.cssSelector("div.cart-summary-totals div.cart-summary-line:nth-child(1) span.value");

	private By total = By.cssSelector("div.cart-summary-totals div.cart-summary-line:nth-child(2) span.value");
	...
	public String obter_numerosItensTotal() {
		return driver.findElement(numerosItensTotal).getText();
	}
	...
	public String obter_summaryTotal() {
		return driver.findElement(summaryTotal).getText();
	}

	public String obter_total() {
