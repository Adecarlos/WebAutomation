...
public class ModalProdutoPage {
	...
	private By tamanhoProduto = By.cssSelector("div.divide-right .col.md-6");
	...
	public String obterMensagemProdutoAdicionado() {
		FluentWait wait = new FluentWait(driver).withTimeout(Duration.ofSeconds(7)).pollingEvery(Duration.ofSeconds(1)).ignoring(org.openqa.selenium.NoSuchElementException.class);
